...
public class Figure2 extends Actor{
    int blockSize;
    BlockSpawner mommy;
    World w;
    ...
    private int startX = 326;
    private int startY;
    private int[] startPos = new int[2];
    
    private int positionsState = 0;
    
    public Figure2(int blockSize, BlockSpawner mommy) {
